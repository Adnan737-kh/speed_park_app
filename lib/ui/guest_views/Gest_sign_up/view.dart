...
class GestSignUpPage extends StatelessWidget {
  final logic = Get.put(GestSignUpLogic());
  final state = Get.find<GestSignUpLogic>().state;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5),
        GetBuilder<GestSignUpLogic>(builder: (logic) {
          return MyField(
            visibile: visible,
