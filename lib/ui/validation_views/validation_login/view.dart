...
class ValidationLoginPage extends StatelessWidget {
  final logic = Get.put(ValidationLoginLogic());
  final state = Get.find<ValidationLoginLogic>().state;

   ValidationLoginPage({super.key});
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              GetBuilder<ValidationLoginLogic>(
                builder: (logic) {
                  return FormWidget(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        GetBuilder<ValidationLoginLogic>(builder: (logic) {
          return MyField(
            visibile: visible,
