...
class ListViewPageOfDriverName extends StatelessWidget {
  final List<CarHistoryModel> dataSet;

  ListViewPageOfDriverName({required this.dataSet});

  Future<Uint8List> buildPrintablePagedrivername(List<CarHistoryModel> dataSet) async {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            Printing.layoutPdf(
              onLayout: (PdfPageFormat format) async => await buildPrintablePagedrivername(dataSet),
            );
          },
